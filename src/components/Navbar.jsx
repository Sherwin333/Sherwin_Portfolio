...
export default function Navbar() {
  ...
  return (
    <>
      {/* Scroll progress bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 origin-left z-[60]"
      ...
      >
        <div className="mx-auto max-w-6xl px-4">
          ...
          >
            ...
            <motion.a
              href="#home"
              className="relative text-lg font-black tracking-tight z-10 flex items-center gap-2"
            ...
            <motion.button
              className="md:hidden w-9 h-9 rounded-lg border border-white/20 hover:bg-white/10 flex items-center justify-center"
              onClick={() => setOpen((v) => !v)}
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="fixed top-16 left-4 right-4 md:hidden z-50"
            >
                ...
                <ul className="relative px-4 py-4 space-y-1">
                  ...
                  >
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-fuchsia-500 text-white font-semibold"
                      onClick={closeMenu}
                      whileTap={{ scale: 0.98 }}
                    >
